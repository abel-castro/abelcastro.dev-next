...
function PaginationNumber({
  ...
  const className = clsx(
    "flex h-10 w-10 items-center justify-center text-sm border",
    {
      ...
      "z-10 bg-teal-500 text-white-700": isActive,
      "hover:bg-teal-700": !isActive && position !== "middle",
      "text-white-700": position === "middle",
    }
  );
...
function PaginationArrow({
  ...
  const className = clsx(
    ...
    {
      "pointer-events-none text-white-700": isDisabled,
      "hover:bg-teal-700": !isDisabled,
