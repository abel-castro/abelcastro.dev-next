...
describe('generatePagination', () => {
    test('should return all pages if totalPages is 7 or less', () => {
    ...
    test('should handle pages when currentPage is among the first 3 pages', () => {
    ...
    test('should handle pages when currentPage is among the last 3 pages', () => {
    ...
    test('should handle pages when currentPage is in the middle', () => {
